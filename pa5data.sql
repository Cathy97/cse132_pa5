...
-- section
insert into section values(1, 2, 'MAE108', 'sp2018', 2018, 'Adele');
insert into section values(2, 5, 'CSE221', 'sp2018', 2018, 'Kelly Clarkson');
insert into section values(3, 5, 'CSE255', 'sp2018', 2018, 'Flo Rida');
insert into section values(4, 2, 'PHIL12', 'sp2018', 2018, 'Adam Levine');
insert into section values(5, 3, 'CSE221', 'sp2018', 2018, 'Kelly Clarkson');
insert into section values(6, 3, 'CSE105', 'sp2018', 2018, 'Taylor Swift');
insert into section values(7, 3, 'PHIL165', 'sp2018', 2018, 'Adam Levine');
insert into section values(8, 1, 'MAE108', 'sp2018', 2018, 'Selena Gomez');
insert into section values(9, 2, 'CSE221', 'sp2018', 2018, 'Justin Bieber');
insert into section values(10, 5, 'CSE8A', 'sp2018', 2018, 'Adele');
...
-- meeting 24h
insert into meeting values(1, 'LEC', 'M', NULL, 'W', NULL, 'F', 10, 11, 'AM', 00, 00, 'AM');
insert into meeting values(1, 'DIS', NULL, 'Tu', NULL, 'Th', NULL, 10, 11, 'AM', 00, 00, 'AM');
insert into meeting values(1, 'LAB', NULL, NULL, NULL, NULL, 'F', 18, 19, 'PM', 00, 00, 'PM');

insert into meeting values(2, 'LEC', 'M', NULL, 'W', NULL, 'F', 10, 11, 'AM', 00, 00, 'AM');
insert into meeting values(2, 'DIS', NULL, 'Tu', NULL, 'Th', NULL, 11, 12, 'AM', 00, 00, 'PM');
...
insert into meeting values(4, 'DIS', NULL, NULL, 'W', NULL, 'F', 13, 14, 'PM', 00, 00, 'PM');

insert into meeting values(5, 'LEC', 'M', NULL, 'W', NULL, 'F', 12, 13, 'PM', 00, 00, 'PM');
insert into meeting values(5, 'DIS', NULL, 'Tu', NULL, 'Th', NULL, 12, 13, 'PM', 00, 00, 'PM');
...
insert into meeting values(7, 'DIS', NULL, NULL, NULL, 'Th', NULL, 13, 14, 'PM', 00, 00, 'PM');

insert into meeting values(8, 'LEC', NULL, 'Tu', NULL, 'Th', NULL, 15, 16, 'PM', 00, 00, 'PM');
insert into meeting values(8, 'DIS', 'M', NULL, NULL, NULL, NULL, 15, 16, 'PM', 00, 00, 'PM');
insert into meeting values(8, 'LAB', NULL, NULL, NULL, NULL, 'F', 17, 18, 'PM', 00, 00, 'PM');

insert into meeting values(9, 'LEC', NULL, 'Tu', NULL, 'Th', NULL, 17, 18, 'PM', 00, 00, 'PM');
insert into meeting values(9, 'DIS', 'M', NULL, NULL, NULL, 'F', 9, 10, 'AM', 00, 00, 'AM');
...
insert into meeting values(10, 'LAB', NULL, 'Tu', NULL, 'Th', NULL, 15, 16, 'PM', 00, 00, 'PM');


-- takes
insert into takes values( 16, 2, 'letter', 4, 'LEC');
insert into takes values( 16, 2, 'letter', 4, 'DIS');
insert into takes values( 17, 9, 'S/U', 4, 'LEC');
insert into takes values( 17, 9, 'S/U', 4, 'DIS');
insert into takes values( 18, 5, 'letter', 4, 'LEC');
insert into takes values( 18, 5, 'letter', 4, 'DIS');
insert into takes values( 19, 2, 'letter', 4, 'LEC');
insert into takes values( 19, 2, 'letter', 4, 'DIS');
insert into takes values( 20, 9, 'letter', 4, 'LEC');
insert into takes values( 20, 9, 'letter', 4, 'DIS');
insert into takes values( 21, 5, 'S/U', 4, 'LEC');
insert into takes values( 21, 5, 'S/U', 4, 'DIS');
...
insert into takes values( 1, 10, 'S/U', 4, 'LAB');
insert into takes values( 5, 10, 'letter', 4, 'LEC');
insert into takes values( 5, 10, 'letter', 4, 'DIS');
insert into takes values( 5, 10, 'letter', 4, 'LAB');
insert into takes values( 3, 10, 'letter', 4, 'LEC');
insert into takes values( 3, 10, 'letter', 4, 'DIS');
insert into takes values( 3, 10, 'letter', 4, 'LAB');
insert into takes values( 7, 1, 'letter', 4, 'LEC');
insert into takes values( 7, 1, 'letter', 4, 'DIS');
insert into takes values( 7, 1, 'letter', 4, 'LAB');
insert into takes values( 8, 1, 'letter', 4, 'LEC');
insert into takes values( 8, 1, 'letter', 4, 'DIS');
insert into takes values( 8, 1, 'letter', 4, 'LAB');
insert into takes values( 9, 8, 'letter', 4, 'LEC');
insert into takes values( 9, 8, 'letter', 4, 'DIS');
insert into takes values( 9, 8, 'letter', 4, 'LAB');
...
insert into takes values( 12, 4, 'letter', 4, 'DIS');
insert into takes values( 13, 7, 'S/U', 4, 'LEC');
insert into takes values( 13, 7, 'S/U', 4, 'DIS');
insert into takes values( 14, 4, 'letter', 4, 'LEC');
insert into takes values( 14, 4, 'letter', 4, 'DIS');
insert into takes values( 15, 7, 'letter', 4, 'LEC');
insert into takes values( 15, 7, 'letter', 4, 'DIS');
