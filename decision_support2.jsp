        ...
        <td>
            ...
            <%
                ...
                if (action.equals("show_decision1")) {
                    ...
                    pstmt = conn
                    .prepareStatement("SELECT c.grade, c.g_cnt FROM CPG AS c WHERE c.course_id = ? AND c.fac_id = ?");
            ...
            <hr>
            <form action="decision_support2.jsp" method="POST">
            <table border="1">
            <tr>
            <th>Course Id</th>
            <th>Faculty Id</th>
