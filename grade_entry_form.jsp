        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    pstmt = conn
                    .prepareStatement("INSERT INTO student_section (is_enroll, unit, letter_su, grade, stu_id, section_id) VALUES (1, 4, 'letter', ?, ?, ?)");
            ...
            <tr>
                <form action="grade_entry_form.jsp" method="POST">
